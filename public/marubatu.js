...
function do_if_loop(tmp, button2, table_id) {
...
function do_else_if_loop(tmp, button2, table_id) {
...
function show_maru_batu(table_id) {
  ...
  if (id_list.includes(table_id) == true && return_flag(ref1) == true) {
    do_if_loop(tmp, button2, table_id);
    ...
    do_else_if_loop(tmp, button2, table_id);
